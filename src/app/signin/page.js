      ...
      <div className="w-full max-w-md relative">
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 bg-white dark:bg-gray-900 p-8 rounded-2xl border border-gray-200 dark:border-gray-800">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <Link
              href="#"
              className="text-black dark:text-white hover:underline underline-offset-4"
            >
              Forgot password?
            </Link>
          </div>
          ...
          <p className="text-center text-sm text-gray-600 dark:text-gray-400 mt-4">
            ...
            <Link href="/signup" className="text-black dark:text-white hover:underline underline-offset-4 font-medium">
              Sign Up
            </Link>
          </p>
          ...
          <div className="flex gap-3">
            <button
              type="button"
              className="flex-1 flex items-center justify-center gap-2 border border-gray-300 dark:border-gray-600 rounded-lg py-3 hover:border-black dark:hover:border-white transition-colors"
            >
              <svg
                version="1.1"
                width={20}
            ...
            >
              ...
              >
                <path fill="currentColor" d="M15.769,0c0.053,0,0.106,0,0.162,0c0.13,1.606-0.483,2.806-1.228,3.675c-0.731,0.863-1.732,1.7-3.351,1.573 c-0.108-1.583,0.506-2.694,1.25-3.561C13.292,0.879,14.557,0.16,15.769,0z" />
